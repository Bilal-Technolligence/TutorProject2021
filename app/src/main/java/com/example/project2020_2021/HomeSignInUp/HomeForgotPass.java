...
public class HomeForgotPass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_forgot_pass);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HomeForgotPass.this, HomeRegistration.class);
    ...
    private  void  resetPassword()
    {
        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(HomeForgotPass.this,"Check Your Email To Reset Your Password!",Toast.LENGTH_LONG).show();

                }
                else
                {
                    Toast.makeText(HomeForgotPass.this,"Try Again Something Wrong Had Happened!",Toast.LENGTH_LONG).show();
                }
