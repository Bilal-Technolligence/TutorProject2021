...
public class InsForgotPass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ins_forgot_pass);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(InsForgotPass.this, InstituteRegistration.class);
    ...
    private  void  resetPassword()
    {
        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(InsForgotPass.this,"Check Your Email To Reset Your Password!",Toast.LENGTH_LONG).show();

                }
                else
                {
                    Toast.makeText(InsForgotPass.this,"Try Again Something Wrong Had Happened!",Toast.LENGTH_LONG).show();
                }
